...
this.electric = this.physics.add.sprite(electric.x, electric.y, "electric").play("electric-downAnim").setScale(2.5);
this.cockroach = this.physics.add.sprite(cockroach.x, cockroach.y, "cockroach").play("cockroach-upAnim").setScale(2.5);
